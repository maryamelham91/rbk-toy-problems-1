...
function reverseArr(array, left, right) {
    while (left < right) {
        var temp = array[left];
...
function rotate(array, steps) {
    ...
    array = reverseArr(array, 0, l - 1);
        console.log(array);

    array = reverseArr(array, 0, steps - 1);
        console.log(array,steps);

    array = reverseArr(array, steps, l - 1);
        console.log(array);
